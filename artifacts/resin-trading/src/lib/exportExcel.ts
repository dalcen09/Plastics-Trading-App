...
export function exportToExcel(
  ...
  const expand: { colKey: ColumnKey; fields: (keyof ResinEntry)[] }[] = [
    ...
    { colKey: "resinType",           fields: ["resinType"] },
    { colKey: "resinSubType",        fields: ["ppType", "peType", "psType", "absType"] },
    ...
    { colKey: "rohs",                fields: ["rohs"] },
    { colKey: "mesh",                fields: ["mesh"] },
    { colKey: "physicalOther",       fields: ["physicalOther"] },
    { colKey: "shape",               fields: ["shape"] },
    { colKey: "charpy",              fields: ["charpyLower", "charpyUpper"] },
    { colKey: "izod",                fields: ["izodLower", "izodUpper"] },
    { colKey: "mi",                  fields: ["meltFlowIndexLower", "meltFlowIndexUpper"] },
    { colKey: "density",             fields: ["densityLower", "densityUpper"] },
